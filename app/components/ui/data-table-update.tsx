...
interface DataTableProps<TData, TValue> {
  ...
  export function DataTableUpdate<TData,TValue>({columns,data,empty_data_message,filters,paginations}:DataTableProps<TData, TValue>) {
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="">
              {filters[filter_type].column} filter<ChevronDown />
            </Button>
          </DropdownMenuTrigger>
