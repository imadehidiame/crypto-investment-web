  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-destructive text-destructive-foreground text-gray-100 hover:bg-destructive/80",
        ...
        purple: "bg-indigo-600 text-white shadow-sm hover:bg-indigo-700",
